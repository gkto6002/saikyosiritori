        ...
        history.append(
            {
                ...
                "beam_pruned_counts_by_ply": decision.extra.get("beam_pruned_counts_by_ply", ""),
                ...
                "exact_call_events": decision.extra.get("exact_call_events", ""),
                "exact_root_call_count": decision.extra.get("exact_root_call_count", ""),
                "exact_frontier_call_count": decision.extra.get("exact_frontier_call_count", ""),
                "exact_nontrivial_success_count": decision.extra.get("exact_nontrivial_success_count", ""),
                "exact_trivial_success_count": decision.extra.get("exact_trivial_success_count", ""),
                "exact_memo_hit_count": decision.extra.get("exact_memo_hit_count", ""),
                "exact_total_time_sec": decision.extra.get("exact_total_time_sec", ""),
                "exact_fallback_count": decision.extra.get("exact_fallback_count", ""),
                "root_selected_move_had_exact_proof": decision.extra.get("root_selected_move_had_exact_proof", ""),
                "root_choice_changed_by_exact": decision.extra.get("root_choice_changed_by_exact", ""),
